    ...
    if validar_valor_numerico(opcion) == True:
        ...
        if opcion_casteada > -1 and opcion_casteada < 21:
            ...
            if opcion_casteada == 1:
                ...
                mostrar_jugadores_con_estadistica_sobre_valor_ingresado(lista_datos_dream_team,'promedio_puntos_por_partido')
            elif opcion_casteada == 10:
                mostrar_jugadores_con_estadistica_sobre_valor_ingresado(lista_datos_dream_team,'promedio_rebotes_por_partido')
            elif opcion_casteada == 11:
                mostrar_jugadores_con_estadistica_sobre_valor_ingresado(lista_datos_dream_team,'promedio_asistencias_por_partido')
                ...
                mostrar_jugadores_con_estadistica_sobre_valor_ingresado(lista_datos_dream_team,'porcentaje_tiros_libres')
